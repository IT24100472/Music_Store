...
<nav class="nav-container text-white w-full">
    <div class="nav-content">
        <div class="flex items-center justify-between h-16">
            ...
            <div class="hidden md:flex md:items-center space-x-6">
                ...
                <a id="homeButton" href="/admin" class="px-4 py-3 rounded-md text-lg font-medium hover:bg-purple-700 transition-colors">User Management</a>
                <!-- User Management link -->
                <a id="musicButton" href="/admin/music" class="px-4 py-3 rounded-md text-lg font-medium hover:bg-purple-700 transition-colors">Music Management</a>
                <!-- Contact us link -->
    ...
    <div id="mobile-menu" class="md:hidden hidden mobile-menu bg-purple-800 px-4 pt-3 pb-5 space-y-3">
        <a href="/" class="block px-4 py-3 rounded-md text-lg font-medium hover:bg-purple-700 bg-purple-900">
            <i class="fas fa-home mr-3"></i>User Management
        </a>
