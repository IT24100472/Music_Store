    ...
    <style>
        ...
        * {
        ...
        body {
            ...
            min-height: 100vh;
            padding: 100px 20px 20px 20px; /* Added top padding for navbar */
            display: flex;
            justify-content: center;
            align-items: flex-start; /* Changed to flex-start for better positioning */
        }
...
<div class="edit-container">
    <div class="header">
        <h1><i class="fas fa-user-plus mr-2"></i>Add User</h1>
    ...
    <form action="/admin/add" method="post">
        ...
        <div class="form-group">
            ...
            <p style="font-size: 0.875rem; color: #718096; margin-top: 5px;">Create a strong password</p>
        </div>
